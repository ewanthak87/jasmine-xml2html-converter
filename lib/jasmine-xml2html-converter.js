...
this.from = function(reportXml, testConfig) {
  ...
  var testReportFileName = testConfig['fileName'] == undefined ? 'test-html-report' : testConfig['fileName'];
  ...
  // Write report
  fileSystem.writeFileSync(path.join(testOutputPath, '/'+testReportFileName+'.html'), htmlReport);
}
